...
1. **Create Worktree or Branch**
   ...
   - **Naming convention:** `francisfuzz/{issue-number}-short-description`
     - Example: `francisfuzz/42-fix-auth-bug`
...
- **semantic-commit**: For commit message guidance
- **code-review**: For pre-push self-review
